...
//        layoutParams0.leftMargin = margin;
        ...
        for (int i = 0; i < mVideoViewList.size(); i++) {
            ...
            cloudVideoView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
    ...
    public void setRenderRotation(int orient) {
        for (TXCloudVideoView view : mVideoViewList) {
            view.setRenderRotation(orient);
        }
    }
}
